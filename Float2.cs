...
namespace Utils
{
    public struct Float2
    {
        ...
        /// <summary> Returns a random Float2 with vector length shorter or equal to [maxLength]. </summary>
        public static Float2 RandMaxLength(float maxLength)
        {
             float angle = _rand.NextSingle() * MathF.PI * 2;
            float distance = MathF.Sqrt(_rand.NextSingle()) * maxLength; // sqrt for uniform distribution
            return new Float2(
